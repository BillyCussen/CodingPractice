...
import gc
import Decrypt
from Decrypt import myDecryption

#Variables
repeat = "y"

#Greeting
print("***DECRYPTION APP***")
...
while repeat == "y":
    ...
    while inputCheck:
        try:
            sentance = str(input("Please enter the Sentance you want Decoded: "))
        except:
    ...
    #Process and Output
    myDecryptionApp = myDecryption(sentance)
    print(myDecryptionApp.decryptSentance())
